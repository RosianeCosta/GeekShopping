...
{
    /// <inheritdoc />
    public partial class AddOrderDataTableOnD : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    userid = table.Column<string>(name: "user_id", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    couponcode = table.Column<string>(name: "coupon_code", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    email = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    cardnumber = table.Column<string>(name: "card_number", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    cvv = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    expirymonthyear = table.Column<string>(name: "expiry_month_year", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    productname = table.Column<string>(name: "product_name", type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
